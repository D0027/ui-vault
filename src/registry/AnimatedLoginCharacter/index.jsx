...
function AnimatedBoy() {
  ...
  // 🚀 PERFORMANCE HACK: State ab yahan andar hai! 
  // Isse bahar ka Canvas re-render nahi hoga = ZERO LAG & BUTTERY SMOOTH!
  ...
  useEffect(() => {
    const runSequence = async () => {
      ...
      setUiState('pulling'); 
      // FADE TIME INCREASED: Ekdum smooth transition ke liye
      actions['mixamo.com']?.fadeOut(0.5); 
  ...
  useFrame((state, delta) => {
    ...
    if (phase.current === 'walk_in') {
      ...
      // 🎯 PERFECT TOUCH FIX: Distance 2.2 se ghatakar 1.6 kar diya!
    ...
    <>
      ...
      <group ref={formGroup} position={[20, -0.2, 0]}>
        <Html center zIndexRange={[90, 0]}>
          {/* ✨ PREMIUM GLASSMORPHISM UI START ✨ */}
          <div style={{
